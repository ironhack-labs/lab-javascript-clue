...
let weaponsArray = [
    ...
    function randomSelector(array){
     ...
     let misteryEnvelope = pickMistery(cardStack);

     function pickMistery(){
            let mistery = [charactersArray, weaponsArray, roomsArray];
            return misteryEnvelop = mistery.map(card => randomSelector(card));
     }
     pickMistery();
