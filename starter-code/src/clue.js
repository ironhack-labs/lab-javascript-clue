...
var mrGreen = {
    ...
    function pickMistery(){
      var mystery = [randomSelector(charactersArray), randomSelector(weaponsArray), randomSelector(roomsArray)];
      return mystery;
    }
    
    var misteryEnvelope = pickMistery();
    
    function revealMistery(answer){
      return answer[0].first_name + " " + answer[0].last_name + " " + "killed Mr.Boddy using the " + answer[1].name + " in the " + answer[2].name + "!!!!";
    }
