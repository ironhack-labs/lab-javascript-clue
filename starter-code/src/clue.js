...
function randomSelector(array) {
    var nb = Math.floor(Math.random() * (array.length + 1));
    return array[nb];
}
...
return misteryEnvelope.first_name + " " + misteryEnvelope.last_name + " killed Mr.Boddy using the " + misteryEnvelope.weapons.name + " in the " + misteryEnvelope.name
}
