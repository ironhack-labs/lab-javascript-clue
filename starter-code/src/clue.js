...
function pickMystery() {
    ...
    var roo = randomSelector(roomsArray);
    var wea = randomSelector(weaponsArray);
    yo.push(char,wea,roo);
};

var mysteryEnvelope=pickMystery();

function revealMystery(misteryEnvelope){
    return mysteryEnvelope[0].first_name + mysteryEnvelope[0].last_name + "killed Mr. Boddy using the " mysteryEnvelope[1].name + mysteryEnvelope[2].name;
};