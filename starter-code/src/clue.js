...
function revealMistery(misteryEnvelope) {
    var killername = misteryEnvelope[0].first_name;
    var lastname = misteryEnvelope[0].last_name;
    var weaponused = misteryEnvelope[1].name;
    var place = misteryEnvelope[2].name;
    return killername+' '+lastname+' killed Mr.Boddy using the '+weaponused + ' in the ' + place + '!!!!';
}