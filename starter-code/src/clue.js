const mrGreen = {
    ...
    weaponsArray.push(rope,knife,candlestick,dumbbell,poison,axe,
    bat,trophy,pistol);
    
    roomsArray.push(dinningRoom,conservatory,kitchen,study,library,billiardRoom,lounge,
    ...
    // function pushing (pushIt){
       
    //     return weaponsArray.push(pushIt);
    // }
    ...
    //console.log(JSON.stringify(randomSelector(charactersArray)));
     ...
     let newArray = [];
     newArray.push(randomSelector(charactersArray));
     newArray.push(randomSelector(weaponsArray));
     newArray.push(randomSelector(roomsArray));
