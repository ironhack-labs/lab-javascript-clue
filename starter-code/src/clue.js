...
const randomSelector = arrayToRandom => arrayToRandom[randomNumber(arrayToRandom.length)];
...
const revealMystery = mystery =>
  `${mystery.suspect.first_name} ${mystery.suspect.last_name} killed Mr. Boddy using the ${mystery.weapon.name} in the ${mystery.room.name}!!!!`;
