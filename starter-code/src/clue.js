...
let randomNumber = Math.floor( Math.random() * cardArray.length );
    ...
    randomCard = cardArray[randomNumber];
...
function pickMistery() {
  ...
  let misteryEnvelope = [randomSelector (charactersArray), randomSelector (weaponsArray),randomSelector (roomsArray)];
   ...
   let revealedMistery = ` ${misteryEnvelope[0].first_name} ${misteryEnvelope[0].last_name} killed Mr.Boddy using the ${misteryEnvelope[2].name} in the ${misteryEnvelope[1].name} !!!! `;

//console.log(revealedMistery);
//console.log(misteryEnvelope);
  
// console.log(misteryEnvelope[0].frst_name);
