...
function pickMistery(){
  ...
  console.log(misteryEnvelope.length)
...
function revealMistery(theEnvelope) {
  return console.log(`${theEnvelope[0].first_name} ${theEnvelope[0].last_name} killed Mr.Boddy using the ${theEnvelope[1].name} in the ${theEnvelope[2].name}!!!!`);
};
