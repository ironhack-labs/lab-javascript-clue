...
function pickMystery(){
    `Call randomSelector for each card stack, and return 
    an object with the 3 picked cards, a suspect, 
    a weapon and a room.
    `
...
function revealMystery(object){
    let first_name = object.suspect.first_name;
    let last_name = object.suspect.last_name;
    let weapon = object.weapon.name;
    let room = object.room.name;
    let message = `${first_name} ${last_name} killed Mr. Boddy using the ${weapon} in the ${room}!!!!`
    return message;
}