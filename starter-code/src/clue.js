...
var mysteryEnvelope = [randomCharacter + randomRoom + randomWeapon];
...
var misteryEnvelope = characters[Math.floor(Math.random() * characters.length)];
...
function misteryEnvelope () {
  var array = [characters, weapons, rooms]
}
