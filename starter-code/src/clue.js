...
roomsArray.push(dinningRoom,conservatory,
    kitchen,study,library, billiardRoom,
    lounge, ballroom,
    hall, spa, livingRoom, observatory, 
...
// //console.log(randomSelector(test1));
...
// //console.log(pickMistery(test1, test2, test3));

var mystery = pickMistery()
