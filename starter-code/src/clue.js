...
let roomsArray = ['Dinning Room', 'Conservatory','Kitchen','Study','Library','Billiard Room','Lounge','Ballroom','Hall',
...
//Random Selector
function randomSelector(totalcards){
  if(totalcards.length == 0){return undefined}
  let position = Math.floor(Math.random() * (totalcards.length)) + 0
...
function revealMistery(){
  let revelation = pickMistery()
  return `${revelation[0].first_name} ${revelation[0].last_name} killed Mr.Boddy using the ${revelation[1]} in the ${revelation[2]}!!!!`
