...
var  profPlum = 
  {
    ...
    lastName: "Plum",
    color: "Purple",
    description: "Billonare video game designer",
    age: 22,
    image: "http://www.radiotimes.com/uploads/images/Original/111967.jpg",
    occupation: "Designer"
  }
...
/*
function pickMistery (killer, weapon, room){
...
// se que tiene que ir en una funcion pero no se como hacerlo ....
console.log(misteryEnvelope[0].firstName + " " +misteryEnvelope[0].lastName + "killed Mr.Boddy using the " + misteryEnvelope[1].name + " in the " + misteryEnvelope[2].name + " !!!");
