var mrGreen = {
  ...
  var charactersArray = [mrGreen,drOrchid,profPlum,missScarvar,mrsPeacock,mrMustard];

  var roomsArray = [dinningRoom,conservatory,study,library,billiardRoom,lounge,ballroom,hall,spa,observatory,theater,guestHouse,patio];
