...
// Characters Collection //objects array
var charactersArray = [
  mrGreen,
  drOrchid,
  profPlum,
...
// Rooms' Collection // Objects array
var weaponsArray = [
  rope,
  knife,
  candlestick,
...
// Weapons Collection //objects array
var roomsArray = [
  { name: "Dinning Room" },
  { name: "Conservatory" },
  { name: "Kitchen" },
...
function randomSelector(arr) {
  ...
  randomNumber = Math.floor(Math.random() * arr.length); //asign a randomNumber depends on the length of arr passed as argument
...
function pickMistery() {
  ...
  let misteryEnvelope = [character, weapon, room];
