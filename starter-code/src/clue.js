...
for (var i = 0; i<roomsArrayStrings.length;i++) {
    roomsArray.push({name: roomsArrayStrings[i]});
}
...
function revealMistery(envelope) {
    var mysteryReveal = envelope[0].first_name + " " + envelope[0].last_name + " killed Mr.Boddy using the " + envelope[1].name + " in the " + envelope[2].name + "!!!!";
    console.log("ENVELOP", envelope);
