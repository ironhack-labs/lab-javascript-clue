...
var hall={name: "Hall"};
var spa={name: "Spa"};
var livinRoom={name: "Living Room"};
...
// Rooms' Collection
var roomsArray = [];
roomsArray.push(dinningRoom,conservatory,kitchen,study,library,billiardRoom,lounge,ballroom,hall,spa,livinRoom,observatory,theater,guestHouse,patio);
...
function pickMistery () {
    ...
    var misteryArray = [randomCharacters,randomWeapons,randomRooms];
    return misteryArray;
}
...
var result = misteryEnvelope[0].first_name  + ' '+ misteryEnvelope [0].last_name + ' killed Mr.Boddy using the'+ misteryEnvelope [2].name  + ' in the ' + misteryEnvelope [1].name + "!!!!";
return result;
}