...
var mrGreen = {
  ...
  function randomSelecter(arr){
   let randomlySelected = arr[Math.floor(Math.random()*arr.length)];
  console.log(randomlySelected)
  }
  
  // randomSelecter(suspects)
  
  function pickMystery() {
  randomSelecter(charactersArray)
  randomSelecter(weaponsArray)
  randomSelecter(roomsArray)
  
  }
  
  const mysteryEnvelope = []
  
  mysteryEnvelope.push(pickMystery())
