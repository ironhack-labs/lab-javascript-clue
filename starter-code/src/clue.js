...
// Weapons Collection
const weaponsArray = [rope, knife, candlestick, dubmbell, poison, axe, bat, trophy, pistol];
...
function revealMystery(mysteryEnvelope) {
    return mysteryEnvelope.suspect.first_name + " " +
        ...
        mysteryEnvelope.weapon.name + " in the " +
