...
if(stack !=''){
var max=stack.length; //min lo incluye pero max no, por eso no hay que poner stack.length-1
var min = 0;
...
var misterio=firstName+" "+lastName+" killed Mr.Boddy using the "+weapon+" in the "+place+"!!!!";
