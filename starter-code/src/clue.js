...
// Weapons Collection
const weaponsArray = [rope, knife, candlestick, axe, dumbbell, bat, trophy, pistol, poison];
...
let pickMystery = () =>{
    ...
    let misteryEnvelope = { suspect: randomSelector(charactersArray),
...
let revealMystery = misteryEnvelope => {
