...
const pickMystery = () => {
   const mysteryEnvelop = {
       suspect: randomSelector(charactersArray),
       weapon: randomSelector(weaponsArray),
       room: randomSelector(roomsArray),
   }
   return mysteryEnvelop
}



const revealMystery = (mysteryEnvelop) => {
    debugger;
     return mysteryEnvelop.suspect.first_name+ ' ' + mysteryEnvelop.suspect.last_name+' killed Mr. Boddy using the '+mysteryEnvelop.weapon.name+' in the '+mysteryEnvelop.room.name+'!!!!'
}
