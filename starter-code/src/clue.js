...
var dumbbel = {name :"dumbbell", weight: 30}
...
// Weapons Collection
var weaponsArray = [];
weaponsArray.push (rope, knife, candlestick,dumbbel,poison,axe,bat,trophy,pistol)

function randomSelector(randArr){
 var randomcard = randArr[Math.floor(Math.random()*randArr.length)];
 return randomcard;
};
