...
var charactersArray = [mrMustard, mrsPeacock, missScarlet, profPlum, drOrchid, mrGreen]
...
//var mistery=[charactersArray,roomsArray,weaponsArray]
...
function pickMistery(){
 ...
 function revealMistery(misterio){
     console.log(misterio)
     return misterio[0].first_name + " " + misterio[0].last_name + " killed Mr.Boddy using the " +misterio[1].name + " in the "+misterio[2].name + "!!!!"
 }
