...
let mrGreen = {first_name:"Jacob", last_name:"Green", color:"green",description:"He has a lot of connections", age:45,image:"https://pbs.twimg.com/profile_images/506787499331428352/65jTv2uC.jpeg",occupation:"Entrepreneur"};
...
ocupation:   Scientist
*/
let drOrchid = {first_name:"Doctor", last_name:"Orchid", color:"white",description:"PhD in plant toxicology. Adopted daughter of Mr. Boddy", age:26,image:"http://www.radiotimes.com/uploads/images/Original/111967.jpg",occupation:"Scientist"};
/*
profPlum
first_name:   Victor
last_name:    Plum
...
const randomSelector = (array)=>{
        let random = Math.floor(Math.random(0,array.length) * array.length)
        return array[random]
}

const pickMistery = (array, w, s)=>{
    misteryEnvelope = [
...
const revealMistery = (array)=>{
    var output = array[0].first_name+" "+array[0].last_name+" killed Mr.Boddy using the "+array[1].name+" in the "+array[2].name+"!!!!";
    return output;
}
