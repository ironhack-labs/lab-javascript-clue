...
// Rooms' Collection
var roomsArray = [
  DinningRoom, Conservatory, Kitchen, Study, Library, BilliardRoom, Lounge, Ballroom,
...
function revealMistery(mis) {
  return mis[0].first_name + " " + mis[0].last_name + " killed Mr.Boddy using the " + mis[1].name +" in the " + mis[2].name + "!!!!"
} 