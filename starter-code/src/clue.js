...
// Rooms' Collection
let roomsArray = [Dinning_Room, Conservatory, Kitchen, Study, Library, Billiard_Room, Lounge, Ballroom];

// Weapons Collection
let weaponsArray = [rope, knife, candlestick, dumbell, poison, axe, bat, trophy, pistol];
...
function revealMistery() {
    let result = pickMistery();
    console.log(result)
    console.log(`${result[0]['first_name']} ${result[0]['last_name']} killed Mr.Boddy using the ${result[1]['name']} in the ${result[2]['name']}!!!!`)
