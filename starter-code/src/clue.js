  ...
  function pickMistery () {
    var cardCharacter = randomSelector(charactersArray);
    var cardRooms = randomSelector(roomsArray);
    var cardWeapons = randomSelector(weaponsArray);
    var misteryEnvelope = [cardCharacter, cardWeapons, cardRooms];
    return misteryEnvelope;
  }

  function revealMistery (misteryEnvelope) {

    var firstName = misteryEnvelope[0].firstName;
    var lastName = misteryEnvelope[0].lastName;
