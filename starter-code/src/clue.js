...
roomsArray.push(dinningRoom, conservatory, kitchen, study, library, billiardRoom, lounge, ballroom, hall, spa, livingRoom, observatory,theater,
guestHouse, patio);
charactersArray.push(mrGreen, drOrchid, profPlum, missScarlet, mrsPeacock, mrMustard);


function randomSelector(category){
    var card = Math.floor(Math.random()*(category.length));
