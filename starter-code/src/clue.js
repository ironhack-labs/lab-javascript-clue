...
const missScarconst = {
    ...
    age: 31,
    image: "https://metrouk2.files.wordpress.com/2016/07/miss-scarconstt.jpg",
    occupation: "Actor"
}
const mrsPeacock = {
    first_name: "Eleanor",
...
const charactersArray = [mrGreen, drOrchid, profPlum, missScarconst, mrsPeacock, mrMustard];
