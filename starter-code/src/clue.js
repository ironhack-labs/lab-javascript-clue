...
function pickMystery() {
  ...
  //   console.table(mysteryEnvelope);
  return mysteryEnvelope;
}

function revealMystery(mysteryEnvelope) {
  //   console.log(mysteryEnvelope.room.name);
  let msg = `${mysteryEnvelope.suspect.first_name} ${mysteryEnvelope.suspect.last_name} killed Mr. Boddy using the ${mysteryEnvelope.weapon.name} in the ${mysteryEnvelope.room.name}!!!!`;
  //   console.log(msg);
  return msg;
}
