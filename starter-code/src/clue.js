...
return arr.length===0 ? undefined : arr[randomIndex];

}

function pickMistery() {
  let characterSelector = randomSelector(charactersArray);
  let weaponsSelector = randomSelector(weaponsArray);
  let roomsSelector = randomSelector(roomsArray);

  return [characterSelector,weaponsSelector,roomsSelector];
