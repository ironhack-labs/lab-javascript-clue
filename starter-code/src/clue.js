...
const billiarRoom = {name: "Billiard Room"}
...
// Rooms Collection
var roomsArray = [diningRoom, conservatory, kitchen, study, library, billiarRoom, lounge, ballroom, hall, spa, livingRoom, observatory, theater, guestHouse, patio];




function ramdomSelector(charactersArray, weaponsArray, roomsArray) {
  if (charactersArray.length == 0 || weaponsArray.length == 0|| roomsArray == 0) {
    return undefined;
