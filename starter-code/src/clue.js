...
function pickMistery() {
  let misteryEvelope =  [];
  misteryEvelope.push(randomSelector(charactersArray), randomSelector(weaponsArray), randomSelector(roomsArray));
  return misteryEvelope; //array with a person, weapon, and place
}
// Reveal The Mystery 
