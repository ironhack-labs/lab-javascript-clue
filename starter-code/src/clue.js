...
var drOrchid = {
  first_name: 'Doctor', last_name: 'Orchid', color: 'white', description: "PhD in plant toxicology. Adopted daugher to Mr. Boddy",
...
var missScarlet = {
  first_name: 'Kasandra', last_name: 'Scarlet', color: 'red', description: "She is an A-List movie star witha dark past.",
  age: 31, image: 'https://metrouk2.files.wordpress.com/2016/07/miss-scarlett.jpg',
  occupation: 'Actor'}

var mrsPeacock = {
  first_name: 'Eleanor', last_name: 'Peacock', color: 'blue', description: "She is from a wealthy family and uses her status and money to earn popularity.",
