...
// Rooms' Collection
var roomsArray = [dinningRoom, conservatory, study, library, billiardRoom, lounge, ballroom, hall, spa, observatory, theater, guestHouse, patio, kitchen];
...
function revealMistery (misteryEnvelope){
  ...
  // let e = misteryEnvelope[0].first_name + " "+ misteryEnvelope[0].last_name + " killed Mr.Boddy using the " + misteryEnvelope[1].name + " in the " + misteryEnvelope[2].name
  // return [e]
}
