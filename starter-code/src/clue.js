...
var conservatory = {name: 'Con;ervatory'};
...
var roomsArray = [];
roomsArray.push(dining,conservatory,kitchen,study,library,billard,lounge,ballroom,hall,spa,livingRoom,observatory,theater,guestHouse,patio);
...
function randomSelector(arr) {
    var position = Math.floor(Math.random()* Math.floor(arr.length));
    return arr[position];
  }
