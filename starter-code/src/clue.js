...
weaponsArray.push(pistol, trophy, bat, axe, poison, dumbbell, candlestick, knife, rope);
...
function pickMistery() {
    var misteryEnvelopearray = [];

    misteryEnvelopearray.push(randomSelector(charactersArray));
    misteryEnvelopearray.push(randomSelector(weaponsArray));
    misteryEnvelopearray.push(randomSelector(roomsArray));

    return misteryEnvelopearray;
}
