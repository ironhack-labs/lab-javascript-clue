...
let revealMystery = () => {
    ...
    let envelop = `${result.suspect.firstName} ${result.suspect.lastName} killed Mr. Boddy using the ${result.weapon.name} in the ${result.room.name}!`
    // return envelop
    ...
    return console.log(`${result.suspect.firstName} ${result.suspect.lastName} killed Mr. Boddy using the ${result.weapon.name} in the ${result.room.name}!`)}
revealMystery()
