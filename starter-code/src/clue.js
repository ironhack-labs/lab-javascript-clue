...
const weaponsArray = ['DinningRoom', 'Conservatory', 'Kitchen', 'Study', 'Library', 'billiardRoom', 'Lounge', 'Ballroom', 'Hall', 'Spa', 'livingRoom', 'Observatory', 'Theater', 'guestHouse', 'Patio'];
