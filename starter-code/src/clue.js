...
let dumbell = {name: "dumbbell", weight: 30};
let posion = {name: "poison", weight: 2};
...
var charactersArray = [mrGreen, mrMustard, mrsPeacock, drOrchid, profPlum, missScarlet];

// Rooms' Collection
var roomsArray = [dinning, conservatory, kitchen, study, library,
billiardRoom, lounge, ballroom, hall, spa, livingRoom, observatory,
theater, guestHouse, patio];

// Weapons Collection
var weaponsArray = [rope, knife, candlestick, dumbell, posion
...
// for each card stack, and return an array with the 3 picked cards, a character, 
// a weapon and a room. Our mystery should be stored on a misteryEnvelope variable.
...
function revealMistery(pickMistery){
  ...
  return pickMistery[0].first_name +" "+ pickMistery[0].last_name +
  " killed Mr.Boddy using the " + pickMistery[1].name+ " in the "+ pickMistery[2].name + "!!!!";
}