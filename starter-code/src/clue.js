...
var charactersArray = [
  ...
  {first_name: "Jacob", last_name: "Green", color: "Green", description: "Has a lot of connections", age: "45", image: "https://pbs.twimg.com/profile_images/506787499331428352/65jTv2uC.jpeg", occupation: "Entrepreneur"},
...
{first_name: "Eleanor", last_name: "Peacock", color: "Blue", description: "She is from a wealthy family and uses her status and money to earn popularity", age: "36", image: "https://metrouk2.files.wordpress.com/2016/07/mrs-peacock.jpg", occupation: "Socialite"},
...
function pickMistery(){
  var mysteryEnvelope = [randomSelector(charactersArray), randomSelector(weaponsArray), randomSelector(roomsArray)];
  return mysteryEnvelope;
}

function revealMistery(x){
  var reveal = (x[0].first_name + " " + x[0].last_name + " killed Mr.Boddy using the " + x[1].name + " in the " + x[2].name + "!!!!")
  return reveal;    
}