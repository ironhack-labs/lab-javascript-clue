...
function selectRandom(singleArr) {
    return singleArr[Math.floor(Math.random() * singleArr.length)];
}
...
function pickMystery(){
    let suspectVar = selectRandom(suspectsArray),
    roomVar = selectRandom(roomsArray),
    weaponVar = selectRandom(weaponsArray);
    return {suspect: suspectVar, room: roomVar, weapon: weaponVar }
