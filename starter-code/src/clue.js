...
function revealMistery(resultado) {
    var solution = resultado[0].first_name + ' ' + resultado[0].last_name + ' killed Mr.Boddy using the ' + resultado[1].name + ' in the ' + resultado[2].name + '!!!!';
    return solution;
}
