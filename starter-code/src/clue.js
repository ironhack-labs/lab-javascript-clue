...
function pickMistery (){
  ...
  var result = [character,weapon,room];
  return result;
...
function revealMistery (mistery){
  var firstName = mistery[0].first_name;
  var lastName = mistery[0].last_name;
  var weapon = mistery[1].name;
  var room = mistery[2].name;
  var result = firstName+" "+lastName+" killed Mr.Boddy using the "+weapon+" in the "+room+"!!!!";
  return result;
