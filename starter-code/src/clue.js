...
function pickMistery() {
    var killerObject = randomSelector(charactersArray)
    var weaponObject = randomSelector(weaponsArray)
    var roomObject = randomSelector(roomsArray)


   var misteryEnvelope = [killerObject, weaponObject, roomObject]
