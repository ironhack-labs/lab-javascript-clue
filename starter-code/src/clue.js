...
// Rooms
var dinningRom = {name: "Dinning Room"};
...
// Weapons Collection
var weaponsArray = [dinningRom,conservatory,kitchen,study,library,billardRoom,lounge,ballroom,hall,spa,livingRoom,observatory,theater,guestHouse,patio];

function randomSelector (array) {
  var randomNumber = Math.floor(Math.random()*array.length);
  var item = array[randomNumber];
  return item;
}
