...
//### Random Selector 
function randomSelector(clueArray){
if (clueArray.length === 0) return undefined;

var i = Math.floor(Math.random() * clueArray.length);
...
function pickMistery(){
    var returnArray=[];
    returnArray.push(randomSelector(charactersArray),randomSelector(weaponsArray),randomSelector(roomsArray));
    return returnArray;
