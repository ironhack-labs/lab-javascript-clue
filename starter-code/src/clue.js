...
function randomSelector(array) {
  ...
  var randomCard = Math.floor(Math.random() * arrayLength);

  return array[randomCard];
}

function pickMistery() {
  var randomCaracter = randomSelector(charactersArray);
  var randomRoom = randomSelector(roomsArray);
  var randomWeapon = randomSelector(weaponsArray);

  var misteryEnvelope = [randomCaracter, randomWeapon, randomRoom];
