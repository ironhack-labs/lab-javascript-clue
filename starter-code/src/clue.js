...
console.log("The mistery envelope contains: " , pickMistery());


// Solving mistery
var revealMistery = function (envelope) {
  //console.log(envelope);
  var murder = envelope[0].first_name + " " + envelope[0].last_name;
  murder += " killed Mr.Boddy using the " + envelope[1].name;
  murder += " in the " +  envelope[2].name + "!!!!";
  return murder;
}
