...
function selectRandom(carta) {
    return carta[Math.floor(Math.random() * carta.length)];
}

//  console.log(selectRandom(suspectsArray));

// function pickMystery(stack) {
//     return stack[selectRandom(stack)];
// }

// console.log(toName(suspectsArray));
...
function pickMystery() {
    ...
    //console.log({ suspect: suspect, room: room, weapon: weapon})
}
