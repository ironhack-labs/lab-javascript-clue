...
// ITERATION 2-----  CREACION DE UNA FUCION PARA SELECIONAR RANDOM, con esto obtenfo 
function selectRandom(arr) {
    return arr[Math.floor(Math.random() * Object.keys(arr).length)];
}
...
// ITERATION 3---- se utiliza la funcion random, para generar las cartas y asignar uno de cada tipo
