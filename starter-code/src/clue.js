...
// const allCards = [charactersArray, roomsArray, weaponsArray];
...
function revealMystery(mysteryEnvelope) {
    let mysteryStr = mysteryEnvelope.suspect.first_name + " " + mysteryEnvelope.suspect.last_name + " killed Mr. Boddy using the " + mysteryEnvelope.weapon.name + " in the " + mysteryEnvelope.room.name + "!!!!";
    return mysteryStr
}