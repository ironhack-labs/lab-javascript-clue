...
var mrGreen = {
  ...
  function pickMistery() {
    let misteryEnvelope = [] ;
    // if (character.length === 0 || weapon.length===0 || room.length===0) {
    //   return misteryEnvelope 
    // } else {
    //   misteryEnvelope.push(randomSelector(characters), randomSelector(weapon), randomSelector(room))
    // }
    ...
    misteryEnvelope.push(randomCharacter, randomWeapon, randomRoom);
