...
function randomSelector(myArray){
  return myArray[getRandomInt(myArray.length)];
}
...
function revealMistery(myArray){
  return myArray[0].first_name + " " + myArray[0].last_name + " killed Mr.Boddy using the " + myArray[1].name + " in the " + myArray[2].name + "!!!!";
}
