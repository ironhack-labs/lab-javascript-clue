...
function revealMystery(folder) {
  return `${folder.suspect.firstName} ${folder.suspect.lastName} killed Mr. Boddy using the ${folder.weapon.name} in the ${folder.room.name}!`;
}
