...
var arrayf= pickMistery();

function revealMistery (arrayf){
  
  return arrayf[0].first_name + " " + arrayf[0].last_name + " killed Mr.Boddy using the "+ arrayf[1].name+" in the "+arrayf[2].name
}
