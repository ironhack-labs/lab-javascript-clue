...
function revealMistery(input) {
  let murdererFirst = input[0].first_name;
  let murdererLast = input[0].last_name;
  let waepon = input[1].name;
  let place = input[2];
  let victimFirst = input[3].first_name;
  let victimLast = input[3].last_name;

  console.log(
    `${murdererFirst} ${murdererLast} killed Mr. ${victimLast} using the ${waepon} in the ${place}!`
  );
}

envelope = pickMistery();
