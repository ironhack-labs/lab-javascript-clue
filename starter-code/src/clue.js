...
// At the beginning of the game, players shuffle each one of the card stacks to create a combination of 
// suspect, weapon and room. This will be the mystery to solve.
