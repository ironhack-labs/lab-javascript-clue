...
function pick_mistery() {
  var character = random_selector(charactersArray);
  var weapon = random_selector(weaponsArray);
  var room = random_selector(roomsArray);
  var envelope = {character, weapon, room};
  return envelope;
}

function reveal_mistery(mistery) {
  console.log(mistery.character.first_name + " " + mistery.character.last_name + " killed Dr. Black at the " + mistery.room.name + " with a " + mistery.weapon.name + " that weighed " + mistery.weapon.weight + " kg");
}
