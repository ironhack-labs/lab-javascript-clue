...
function pick_mistery() {
  var charRandom = random_selector(charactersArray);
  var weaponsRandom = random_selector(weaponsArray);
  var roomsRandom = random_selector(roomsArray);
  var caseFileConfidential = [charRandom, weaponsRandom, roomsRandom];
