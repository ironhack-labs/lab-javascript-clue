...
function random_selector(array) {
  ...
  var ramdomIndex = Math.random()*arrayLength
  var ramdomIndexIntegrer = Math.floor(ramdomIndex)
  var chooseCart = array[ramdomIndexIntegrer];
  return chooseCart;
...
function pick_mistery() {
  ...
  for (var i = 0; i < stacks.length; i++) {
    //console.log(random_selector(stacks[i]))
    virtualEnvelope.push(random_selector(stacks[i]))
  }
