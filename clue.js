...
function reveal_mistery(mistery) {
  var killer = mistery.character.first_name + " " + mistery.character.last_name;
  var weapon = mistery.weapon.name ;
  var room = mistery.room.name;
  console.log("The killer was " + killer + ". Did it in the " + room + " with a " + weapon);
}
