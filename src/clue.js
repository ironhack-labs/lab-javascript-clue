...
let mrGreen = {
  ...
  //Get random item from each array and constructs the mystery
  ...
  //Who killed Mr. Body with what in which room
  ...
  //Loops through all the arrays and shows eachItem's name
     ...
     console.log(guessedSuspect, guessedRoom, guessedWeapon);
      ...
      if(
        ...
        guessedWeapon === mystery.weapon.name){
          ...
          alert(mystery.suspect.name + ' killed Mr. Body in the '+ mystery.room.name + ' with the ' + mystery.weapon.name);
      }
