...
function pickMystery() {
  let revealSuspect = selectRandom(suspectsArray)
  let revealRooms = selectRandom(roomsArray)
  let revealWeapon = selectRandom(weaponsArray)

  let result = new Object()

  result.suspect = revealSuspect
  result.room = revealRooms
  result.weapon = revealWeapon
