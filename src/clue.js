...
function revealMystery(myMystery) {
    ...
    let mysteryMurderer = `${myMystery.suspect.firstName} ${myMystery.suspect.lastName} killed Mr. Boddy using the ${myMystery.weapon.name} in the ${myMystery.room.name}!`;

    return mysteryMurderer;
};
