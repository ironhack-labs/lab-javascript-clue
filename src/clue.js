...
function selectRandom(someArray) {
  const randomCard = someArray[Math.floor(Math.random() * someArray.length)]
...
function pickMystery() {
  ...
  const mystery1 = new mystery(randomSuspect, randomWeapon, randomRoom)
  return mystery1
...
function revealMystery(envelope) {
  const someEnvelope = pickMystery()
