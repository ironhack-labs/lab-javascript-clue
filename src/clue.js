...
]; // Just a moment... After thar I think I don´t have eyes anymore...
...
function pickMystery() {    
    const mystery = { // First I put this as an array, it has to be an object for Jasmine....
...
function revealMystery(reveal) {
    let solveMystery = `${reveal.suspect.firstName} ${reveal.suspect.lastName} killed Mr.Boddy using the ${reveal.weapon.name} in the ${reveal.room.name}!` // This is right but Jasmine tells me no.... WHY??????? 
    return solveMystery;
}
