...
function pickMistery() {
    let secretenvelope = [];
    secretEnvelope.push(selectRandom(suspectsArray[firstname, lastname]));
    secretEnvelope.push(selectRandom(roomsArray[name]));
    secretEnvelope.push(selectRandom(weaponsArray[name]));
