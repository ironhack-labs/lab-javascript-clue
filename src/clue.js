...
function pickMystery() {
  let mystery = {};
  // const pickSuspect = Math.floor(Math.random() * suspectsArray.length);
  // const pickWeapon = Math.floor(Math.random() * weaponsArray.length);
  // const pickRoom = Math.floor(Math.random() * roomsArray.length);
