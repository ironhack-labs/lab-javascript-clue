...
function selectRandom(chair) {


    const randonValue = chair[Math.floor(Math.random() * chair.length)]
...
// const randonsuspect = Math.floor(Math.random() * this.suspectsArray.length)
