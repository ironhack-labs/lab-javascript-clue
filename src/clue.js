...
function revealMystery(envelope) {
  let mysteryRevealed = envelope
  return `${mysteryRevealed.suspect.firstName} ${mysteryRevealed.suspect.lastName} killed Mr. Boddy using the ${mysteryRevealed.weapon.name} in the ${mysteryRevealed.room.name}!`
}
