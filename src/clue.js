...
const suspectsArray = [
    ...
    },
    {
        ...
        occupation: "Designer",
        age: 22,
        description: "He has Billionaire video game designer",
...
function revealMystery(mistery) {
    let message = `${mistery.suspect.firstName} ${mistery.suspect.lastName} killed Mr. Boddy using the ${mistery.weapon.name} in the ${mistery.room.name}!`
    return message
}
