...
Let's create an array for every card type. These arrays should be named suspectsArray, weaponsArray, roomsArray. 
...
const cartas = [selectRandom, weaponsArray, roomsArray] 
...
function pickMystery() {
    ...
    let room = selectRandom(roomsArray);
     ...
     let combinacion = { suspect, weapon, room }
...
function revealMystery(combinacion) {
    return (combinacion.firstName+combinacion.lastName+" killed Mr. Boddy using the " + combinacion.weapon + " in the "+ combinacion.room)
}