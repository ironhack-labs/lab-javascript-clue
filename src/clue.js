...
/*  create Random selector - select one element from a card stack
 ...
 function selectRandom (ar) {
  ...
  const randomElement = Math.floor(Math.random()*weaponsArray.length)
  console.log(randomElement,weaponsArray[randomElement]);
