...
function revealMystery(mystery) {
  // let killerFirstName = mystery.suspect.firstName;
  // let killerLastName = mystery.suspect.lastName;
  // let weapon = mystery.weapon.name;
  // let room = mystery.room.name;

  // return `${killerFirstName} ${killerLastName} killed Mr. Boddy using the ${weapon} in the ${room}!`;
