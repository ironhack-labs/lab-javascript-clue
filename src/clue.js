...
function pickMystery() {
  ...
  randomSelection.suspect = suspect
  randomSelection.room = room
  randomSelection.weapon = weapons
...
function revealMystery(pickMystery) {
  let name = pickMystery.suspect.firstName + ' ' + pickMystery.suspect.lastName;
