...
function selectRandom(cardsArray){
    let card = Math.floor(Math.random()*cardsArray.length)
...
function revealMystery(myMystery){
    ...
    let mysteryMessage = `${myMystery.suspect.firstName} ${myMystery.suspect.lastName} killed Mr. Boddy using the ${myMystery.weapon.name} in the ${myMystery.room.name}!`
