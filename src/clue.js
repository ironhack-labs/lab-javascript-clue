...
// randomSuspect, randomRoom, randomWeapon

// ITERATION 3

function revealMystery(randomSet) {
  return randomSet.suspect.firstName + " " + randomSet.suspect.lastName + ' killed Mr. Boddy using the ' + randomSet.weapon.name + ' in the ' + randomSet.room.name + '!'
}
