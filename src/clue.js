...
const suspectsArray = [
    {
        ...
        age: 45,
        description: 'He has a lo of connectios',
...
function selectRandom(elementCard) {
    if (elementCard.length === 0) {
        return ;
    } else { 
        return elementCard[Math.floor(Math.random() * elementCard.length)];
    }
