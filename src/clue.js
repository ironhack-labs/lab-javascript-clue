...
//   let suspect = suspectsArray[Math.floor(Math.random() * suspectsArray.length)] + weaponsArray[Math.floor(Math.random() * weaponsArray.length)] + roomsArray[Math.floor(Math.random() * roomsArray.length)]
// return suspect
// }
...
function revealMystery() {
  ...
  return `${envelope[0]} ${envelope[0].lastName} killed Mr. Boddy using the ${envelope[1].name} in the ${envelope[2].name}!`
}
