...
// Suspects Collection
const suspectsArray = [
    mrGreen, mrMustard, missScarlet
];

// Rooms Collection
const roomsArray = [
    kitchen, study, library, diningRoom, conservatory, billiardRoom, lounge, ballroom, hall, spa, livingRoom, observatory, theater, guestHouse, patio
];
