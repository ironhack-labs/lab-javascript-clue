...
function selectRandom(array) {
        ...
        const propieties = Object.keys(array);
        let randomPropertyIndex = Math.floor(Math.random() * propieties.length);
        const randomProperty = propieties[randomPropertyIndex]
        return array[randomProperty] 
