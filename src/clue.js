...
function selectRandom(array) { 
  let selectElement = [Math.floor(Math.random()*array.length)]
  return array[selectElement]
}
function pickMystery() {
    let objectMystery = {};
    objectMystery.suspect = selectRandom(suspectsArray)
    objectMystery.weapon = selectRandom(weaponsArray)
    objectMystery.room = selectRandom(roomsArray)
