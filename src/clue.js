...
function pickMystery() {
    ...
    randomSelector = Math.floor(Math.random())

    mysteryObject.suspect = suspectsArray[randomSelector]

    mysteryObject.weapon = weaponsArray[randomSelector]

    mysteryObject.room = roomsArray[randomSelector]
