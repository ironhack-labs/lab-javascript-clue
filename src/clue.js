...
function selectRandom(someArr) {
  ...
  let randomElement = someArr[randomIndex];
...
function revealMystery(envelope) {
  let suspectFN = envelope.suspect.firstName;
  let suspectLN = envelope.suspect.lastName;
  let weapon = envelope.weapon.name;
  let room = envelope.room.name;
  let message = `${suspectFN} ${suspectLN} killed Mr. Boddy using the ${weapon} in the ${room}!`;
  return message;
}
