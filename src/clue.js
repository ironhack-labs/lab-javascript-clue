...
suspect = JSON.stringify(pickMystery().suspect);
console.log(suspect);
console.log(suspectsArray.findIndex(el => JSON.stringify(el)));
console.log(suspectsArray.findIndex(el => JSON.stringify(el) === suspect));
console.log(JSON.stringify(pickMystery().weapon));
console.log(JSON.stringify(pickMystery().room));

// ITERATION 3

misteryobj = pickMystery();
...
console.log(revealMystery(misteryobj));