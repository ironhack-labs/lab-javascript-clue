...
function revealMystery(misteryReveal) {
  return `"${misteryReveal.suspect.firstName} ${misteryReveal.suspect.lastName} killed Mr. Boddy using the ${misteryReveal.weapons.name} in the ${misteryReveal.rooms.name}"`;
}
