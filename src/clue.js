...
// Suspects Collection
const suspectsArray = [
    {firstName: 'Jacob', lastName: 'Green', occupation: 'Entrepreneur', age: 45, description: 'He has a lot of connections.', image: 'https://pbs.twimg.com/profile_images/506787499331428352/', color: 'green'},
...
function pickMystery (){
    ...
    mysteryObject.suspect = card;
    selectRandom (weaponsArray);
    mysteryObject.weapon = card;
    selectRandom (roomsArray);
    mysteryObject.room = card;
