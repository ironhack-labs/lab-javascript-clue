...
function selectRandom(array) {
    ...
    //const finalCard = array(randomElement)
...
function pickMystery() {
    //  const suspectSelected = selectRandom(suspectsArray)
    //const weaponsSelected = selectRandom(weaponsArray)
    //const roomSelected = selectRandom(roomsArray)
