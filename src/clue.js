...
function selectRandom(inputArray) {
  ...
  console.log(inputArray[random]);
  return inputArray[random];
}

function pickMystery() {

  let ourSuspect = selectRandom(suspectsArray);

  let ourRoom = selectRandom(roomsArray);

  let ourWeapon = selectRandom(weaponsArray);

  let result = {suspect: ourSuspect, room: ourRoom, weapon: ourWeapon};
