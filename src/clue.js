...
// ITERATION 2.1 - Random selector - Declare a function named selectRandom to select one element from a card stack randomly. The function should expect an array as an argument and should return a random element from the array.

function selectRandom(cardArr) {
  const randomNumber = Math.floor(Math.random() * cardArr.length);
  const randomElement = cardArr[randomNumber];
...
// ITERATION 2.2 - Create the mistery
