...
function pickMystery() {
    ...
    mistery.suspect = suspect
    mistery.weapon = weapon
    mistery.room = room 
...
function revealMystery(object) {
    ...
    const resultado = `${object.suspect.firstName} ${object.suspect.lastName} killed Mr. Boddy using the ${object.weapon.name} in the ${object.room.name}!`
