...
function selectRandom(array) {
  randomElemIndx = Math.floor(Math.random() * Math.floor(array.length));
  let randomElem = array[randomElemIndx];
...
function pickMystery() {
  let cardCombo = {};
  cardCombo.suspect = selectRandom(suspectsArray);
  cardCombo.weapon = selectRandom(weaponsArray);
  cardCombo.room = selectRandom(roomsArray);
