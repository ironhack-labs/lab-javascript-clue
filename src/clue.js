...
function pickMystery() {
    ...
    pickedStuff.suspect = selectRandom(suspectsArray);
    pickedStuff.room = selectRandom(roomsArray);
    pickedStuff.weapon = selectRandom(weaponsArray);
