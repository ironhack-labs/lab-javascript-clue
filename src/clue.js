...
function pickMystery(){
  ...
  // console.log(suspect.firstName, weapon.name, room.name )
  return { suspect, weapon, room }
};

// ITERATION 3
function revealMystery(envelope) {
  return `${envelope.suspect.firstName} ${envelope.suspect.lastName} killed Mr. Boddy using the ${envelope.weapon.name} in ${envelope.room.name}!`;
}
