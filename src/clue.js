...
const mrsPeacock = new Suspect('Eleanor', 'Peacock', 'Socialité', 36, 'She is from a wealthy family and uses her status and money to earn popularity', 'https: //metrouk2.files.wordpress.com/2016/07/mrs-peacock.jpg', 'red')
...
function pickMystery() {
    ...
    let suspectsArray = selectRandom(Suspect);
    let weaponsArray = selectRandom(Weapon);
    let roomsArray = selectRandom(Room);

    return {suspectsArray, weaponsArray, roomsArray}
}
