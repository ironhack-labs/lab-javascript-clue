...
const suspectsArray = [
  ...
  },
  {
    ...
    image: "https://66.media.tumblr.com/ee7155882178f73b3781603f0908617c/tumblr_phhxc7EhPJ1w5fh03_540.jpgi",
    color: "purple"
  },
  {
    firstName: "Kasandra",
...
function selectRandom(collection) {
  let randomElection = Math.floor(Math.random() * collection.length)
  // console.log("selecRandom")
  // console.log(collection)
  // console.log(randomElection)
  return collection[randomElection]
}
