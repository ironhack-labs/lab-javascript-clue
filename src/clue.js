...
const theMistery=pickMystery()

console.log(theMistery)

function revealMystery(objet) { 
  return `${objet.suspect.firstName} ${objet.suspect.lastName} killed Mr. Boddy using the ${objet.weapon.name} in the ${objet.room.name}!`
