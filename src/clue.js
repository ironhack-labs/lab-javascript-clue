...
pickMystery()
console.log(pickMystery(mystery))


// ITERATION 3

function revealMystery(mystery) {
  console.log(mystery.suspect.name + ' killed Mr.Boddy in the ' + mystery.room.name + ' with the ' + mystery.weapon.name)
}
