...
console.log('Killer: ', selectRandom(suspectsArray));
console.log('Weapon: ', selectRandom(weaponsArray));
console.log('Room: ', selectRandom(roomsArray));
...
const answer = () => {
    let result = revealMystery(pickMystery());
    console.log(result);
};