...
function revealMystery (Misterio){
    ...
    pickMystery(); 
   return Misterio.suspect.firstName + " "  + Misterio.suspect.lastName + "killed Mr. Boddy using the" + Misterio.weapon.name + "in the" + Misterio.room + "!"
   //return <FIRST NAME> <LAST NAME> killed Mr. Boddy using the <WEAPON> in the <ROOM>!
   }
   console.log (revealMystery (Misterio));