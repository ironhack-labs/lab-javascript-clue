...
function selectRandom(cardsArray) {
    ...
    return cardsArray[randomResult];
}
...
function revealMystery (envelope) {
    ...
    const firstNameReveal = envelope.suspect.firstName;
    const lastNameReveal = envelope.suspect.lastName;
    const weaponReveal = envelope.weapon.name;
    const roomReveal = envelope.room.name;

    return `${firstNameReveal} ${lastNameReveal} killed Mr. Boddy using the ${weaponReveal} in the ${roomReveal}!`
 
}

const theMysteryResult = pickMystery();

console.log(revealMystery(theMysteryResult));
