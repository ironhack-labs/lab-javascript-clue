...
//const newSuspect = selectRandom(suspectsArray)
//const newRoom = selectRandom(roomsArray)
//const newWeapon = selectRandom(weaponsArray)
...
function revealMystery(obj) {
  ...
  //return((pickMystery()).suspect.lastName)
  return message
}
