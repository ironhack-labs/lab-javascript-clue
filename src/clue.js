...
function pickMystery() {
  let mysterySuspects = selectRandom(suspectsArray);
  let mysteryRooms = selectRandom(roomsArray);
  let mysteryWeapons = selectRandom(weaponsArray);
  return {
    suspect: mysterySuspects,
    weapon: mysteryWeapons,
    room: mysteryRooms,
  };
}
