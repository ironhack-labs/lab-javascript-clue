...
suspectsArray.splice(1,0,drOrchid,profPlum,missScarlet,mrsPeacock,mrMustard);
...
//let combinedArray = suspectsArray.concat(weaponsArray,roomsArray);
...
const revealMessage = revealMystery(newObject);
