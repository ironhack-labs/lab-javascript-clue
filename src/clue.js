...
function revealMystery(pickMystery) {
    const firstName = pickMystery['suspect']['firstName'];
    const lastName = pickMystery['suspect']['lastName'];
    const weapon = pickMystery['weapon']['name'];
    const room = pickMystery['room']['name'];
    const mystery = `${firstName} ${lastName} killed Mr. Boddy using the ${weapon} in the ${room}!`
