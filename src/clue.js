...
function selectRandom(array) {
  const randomSuspect = array[Math.floor(Math.random() * array.length)];
...
pickMystery();
const solution ='';
// solution += randomMystery.suspect.firstName + ' ' + randomMystery.suspect.lastName + ' killed Mr.Boddy using the ' +randomMystery.weapon.weapon +' in the ' + randomMystery.room;
return solution;
}
revealMystery();
