...
// Rooms Collection
const roomsArray = [diningRoom,conservatory,kitchen,study,library,billiardRoom,hall,spa,livingRoom,observatory,theater,guestHouse,patio];
...
function selectRandom(arr){
    let thing = arr[Math.floor(Math.random() * arr.length)];
    return thing;
}
