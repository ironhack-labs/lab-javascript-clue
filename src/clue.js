...
function selectRandom (card) {
    let number= Math.floor(Math.random()*card.length);
     return card [number];
}
...
return envelope[0].firstName+' '+
envelope[0].lastName+' killed Mr.Boddy using the '+
envelope[2].name + ' in the room'+ envelope[1].name +'!!!!';
}
