...
function selectRandom(playerCards) {
let yourCard;
const min = 0;
const max = playerCards.length;
const randomindex = Math.floor(Math.random() * (max - min)) + min;

yourCard = randomindex;

return yourCard = playerCards[randomindex];
}
...
// const mysteryNow = [];
// mysteryNow.push(selectRandom(suspectsArray));
// mysteryNow.push(selectRandom(weaponsArray));
// mysteryNow.push(selectRandom(roomsArray));
// return mysteryNow;
return{
