...
function revealMystery(mistery) {
  console.log(`${mistery.Suspect.firstName} ${mistery.Suspect.lastName} killed Mr. Boddy using the ${mistery.Weapon.name} in the ${mistery.Room.name}`)
}
revealMystery(card)
