...
function selectRandom(array) {
  ...
  function pickMystery() {
    mysteryObject.suspect = mysterySuspect;
    mysteryObject.room = mysteryRoom;
    mysteryObject.weapon = mysteryWeapon;
...
function revealMystery(envelope) {
    let firstNameKiller = envelope.suspect.firstName;
    let lastNameKiller = envelope.suspect.lastName;
    let weaponUsed = envelope.weapon.name;
    let killingRoom = envelope.room;
  
    return firstNameKiller + " " + lastNameKiller + " killed Mr. Boddy using the " + weaponUsed + " in the " + killingRoom + "!"
  }
