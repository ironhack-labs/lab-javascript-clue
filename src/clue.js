...
function revealMystery(revealArray) {     
    return `${revealArray.suspect.firstName} ${revealArray.suspect.lastName} killed Mr. Boddy using the ${revealArray.weapon.name} in the ${revealArray.room.name}!` 
    }
