...
// ITERATION 2 En este me ayudó Marina a sacar la lógica porque no era consciente que podia devolver una funcion tres objetos :/

function selectRandom(array) {

    const finalArray = (Math.floor(Math.random() * array.length))
