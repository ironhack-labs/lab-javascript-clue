...
function revealMystery(fuckMystery) {
    
    return `${fuckMystery.suspect.firstName} ${fuckMystery.suspect.lastName} killed Mr. Boddy using the ${fuckMystery.weapon.name} in the ${fuckMystery.room.name}!`
}
